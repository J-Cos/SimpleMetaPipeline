#settings
    ...
    # general settings
        ...
        path <-"../../BioinformaticPipeline_Env"             # this should be the path to the working directory within which you have the following folders:
    ...
    #BLAST
        ...
        assignmentThresholds=c(0, 0, 0, 85, 90, 95, 97)
