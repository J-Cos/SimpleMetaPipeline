#settings
    ...
    # DADA2 settings
        ...
        truncLen=list(c(145,145), c(145,145), c(145,145), c(145,145), c(145,145), c(145,145), c(145,145))
            #the length at which the sequences should be truncated (forward and reverse)
        trimLeft=list(c(0,0), c(0,0), c(0,0), c(0,0), c(0,0), c(0,0), c(0,0) )
