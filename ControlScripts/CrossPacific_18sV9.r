#settings
    ...
    # general settings
        ...
        dataname="CrossPacific_18sV9"
            # this should be the name you associate with this set of fastqs,  the input fastq folder should be labelled with this
    ...
    # DADA2 settings
        truncLen=c(145, 145) # seqs are 150 long and good quality - so jsut trimming ends where errors can be poory controlled
