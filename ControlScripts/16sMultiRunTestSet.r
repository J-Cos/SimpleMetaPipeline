#settings
    ...
    # DADA2 settings
        ...
        truncLen=list(  c(150,150),
                        c(115,97)                    
                    )
            #a list of the lengths at which the sequences should be truncated (forward and reverse) for each run
        trimLeft=list(  c(0,0),
                        c(0,0)                    
                    )
            # a list of the # of bases to remove from the start of the sequences (forward and reverse) for each run
        maxN=0
